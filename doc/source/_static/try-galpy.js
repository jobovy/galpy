...
$(document).ready(function() {
    ...
    if ( mobileAndTabletCheck() )
        $(this).parent().parent().prepend('<iframe src="https://www.galpy.org/repl?toolbar=true&code=import%20galpy%0A%23Type%20some%20code%20and%20press%20Shift%2BEnter%20to%20run" width="100%" height="525px" style="display:block;margin: 0 auto;"></iframe>');
    else
