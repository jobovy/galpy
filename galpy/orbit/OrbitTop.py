...
from .Orbits import _check_roSet, _check_voSet, _helioXYZ, _lbd, _radec, \
...
class OrbitTop(object):
    ...
    def __call__(self,*args,**kwargs):
        ...
        if hasattr(self,'t') and nu.all(t == self.t): # Common case where one wants all integrated times
            return self.orbit.T
