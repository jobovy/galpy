###############################################################################
#   EarthPREMPotentialpy: The potential of Earth based on PREM model
###############################################################################
...
pieces = [
    ...
    (
        12.5815
        - 1.2638 * (r / EARTH_RADIUS_KM)
        - 3.6426 * (r / EARTH_RADIUS_KM) ** 2
        - 5.5281 * (r / EARTH_RADIUS_KM) ** 3,
        1221.5,
        3480.0,
    ),
    (
        7.9565
        - 6.4761 * (r / EARTH_RADIUS_KM)
        + 5.5283 * (r / EARTH_RADIUS_KM) ** 2
        - 3.0807 * (r / EARTH_RADIUS_KM) ** 3,
        3480.0,
        5701.0,
    ),
