            ...
            try:
                ...
                if not amp_units == "velocity2":
                    raise units.UnitConversionError(
                        "amp= parameter of {} should have units of {}, but has units of velocity2 instead".format(
            ...
            if not unitFound:
                ...
                try:
                    ...
                    if not amp_units == "mass":
                        raise units.UnitConversionError(
                            "amp= parameter of {} should have units of {}, but has units of mass instead".format(
                                type(self).__name__, amp_units
                            )
                        )
            if not unitFound:
                ...
                try:
                    ...
                    if not amp_units == "density":
                        raise units.UnitConversionError(
                            "amp= parameter of {} should have units of {}, but has units of density instead".format(
                                type(self).__name__, amp_units
                            )
                        )
            if not unitFound:
                ...
                try:
                    ...
                    if not amp_units == "surfacedensity":
                        raise units.UnitConversionError(
                            "amp= parameter of {} should have units of {}, but has units of surface density instead".format(
                                type(self).__name__, amp_units
                            )
                        )
            if not unitFound:
                raise units.UnitConversionError(
                    "amp= parameter of {} should have units of {}; given units are not understood".format(
                        type(self).__name__, amp_units
                    )
                )
            else:
