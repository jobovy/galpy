    ...
    def surfdens(self, R, z, phi=0.0, t=0.0, forcepoisson=False):
        ...
        try:
            ...
            if not _quad_needs_backend(xp, absz):
                ...
                # epsabs=1.49e-8 is ABSOLUTE, so a vertical integral whose own
                # value is at or below ~1e-8 in internal units passes on the first
                # crude estimate and returns success while being ~1e-5 wrong.
