...
def test_orbit_interface_unbound_simple_adiabatic_noc():
    ...
    assert (
        numpy.fabs(jr[0] - aAAnoc(obs[0])[0]) < 10.0**-10.0
    ...
    assert (
        numpy.fabs(jp[0] - aAAnoc(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jz[0] - aAAnoc(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(e[0] - aAAnoc.EccZmaxRperiRap(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(zmax[0] - aAAnoc.EccZmaxRperiRap(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rperi[0] - aAAnoc.EccZmaxRperiRap(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rap[0] - aAAnoc.EccZmaxRperiRap(obs[0])[3]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.isnan(jr[1])
...
def test_orbit_interface_unbound_simple_adiabatic_c():
    ...
    assert (
        numpy.fabs(jr[0] - aAAc(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jp[0] - aAAc(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jz[0] - aAAc(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(e[0] - aAAc.EccZmaxRperiRap(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(zmax[0] - aAAc.EccZmaxRperiRap(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rperi[0] - aAAc.EccZmaxRperiRap(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rap[0] - aAAc.EccZmaxRperiRap(obs[0])[3]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.isnan(jr[1])
    ), "Orbit interface for actionAngleAdiabatic does not return NaN for unbound orbit in a collection with an unbound orbit"
...
def test_orbit_interface_unbound_simple_staeckel_noc():
    ...
    assert (
        numpy.fabs(jr[0] - aASnoc(obs[0])[0]) < 10.0**-10.0
    ...
    assert (
        numpy.fabs(jp[0] - aASnoc(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jz[0] - aASnoc(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(e[0] - aASnoc.EccZmaxRperiRap(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(zmax[0] - aASnoc.EccZmaxRperiRap(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rperi[0] - aASnoc.EccZmaxRperiRap(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rap[0] - aASnoc.EccZmaxRperiRap(obs[0])[3]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.isnan(jr[1])
...
def test_orbit_interface_unbound_simple_staeckel_c():
    ...
    assert (
        numpy.fabs(jr[0] - aASc(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jp[0] - aASc(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jz[0] - aASc(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(omr[0] - aASc.actionsFreqs(obs[0])[3]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(omp[0] - aASc.actionsFreqs(obs[0])[4]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(omz[0] - aASc.actionsFreqs(obs[0])[5]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(wr[0] - aASc.actionsFreqsAngles(obs[0])[6]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(wp[0] - aASc.actionsFreqsAngles(obs[0])[7]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(wz[0] - aASc.actionsFreqsAngles(obs[0])[8]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(e[0] - aASc.EccZmaxRperiRap(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(zmax[0] - aASc.EccZmaxRperiRap(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rperi[0] - aASc.EccZmaxRperiRap(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(rap[0] - aASc.EccZmaxRperiRap(obs[0])[3]) < 10.0**-10.0
    ), "Orbit interface for actionAngleStaeckel does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.isnan(jr[1])
    ), "Orbit interface for actionAngleStaeckel does not return NaN for unbound orbit in a collection with an unbound orbit"
...
def test_orbit_interface_unbound_simple_2d_adiabatic():
    ...
    assert (
        numpy.fabs(jr[0] - aAS(obs[0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jp[0] - aAS(obs[0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert (
        numpy.fabs(jz[0] - aAS(obs[0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.isnan(jr[1])
    ), "Orbit interface for actionAngleAdiabatic does not return NaN for unbound orbit in a collection with an unbound orbit"
...
def test_orbit_interface_unbound_complexshape_adiabatic():
    ...
    assert numpy.all(
        numpy.fabs(jr[:, 0] - aAA(obs[:, 0])[0]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.fabs(jp[:, 0] - aAA(obs[:, 0])[1]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
        numpy.fabs(jz[:, 0] - aAA(obs[:, 0])[2]) < 10.0**-10.0
    ), "Orbit interface for actionAngleAdiabatic does not return the same as actionAngle interface for bound orbit in a collection with an unbound orbit"
    assert numpy.all(
