...
# for the actionAngleTorusStaeckel tests folded in at the end of this file
from galpy.actionAngle import actionAngleStaeckel as _tm_actionAngleStaeckel
from galpy.actionAngle.actionAngleStaeckelInverse import (
    actionAngleStaeckelInverse as _tm_actionAngleStaeckelInverse,
)
from galpy.actionAngle.actionAngleTorusStaeckel import actionAngleTorusStaeckel
from galpy.orbit import Orbit as _tm_Orbit
from galpy.potential import KuzminKutuzovStaeckelPotential as _tm_KKPot
from galpy.potential import OblateStaeckelWrapperPotential as _tm_OSWPot
from galpy.potential import evaluatePotentials as _tm_evalPot
...
# folded into this file so the CI matrix's test_actionAngle.py entry runs them

_KKP = _tm_KKPot(amp=4.0, ac=5.0, Delta=1.3)


def _kk_torus():
    aAS = _tm_actionAngleStaeckel(pot=_KKP, delta=1.3, c=True, order=100)
    return tuple(
...
def test_actionAngleTorusStaeckel_family_uses_true_potential():
    ...
    # silent no-op
    swp = _tm_OSWPot(pot=_KKP, delta=1.3)
    fam = _tm_actionAngleStaeckelInverse(
        pot=swp,
        setup_interp=True,
        Rmin=0.7,
        Rmax=1.6,
...
def test_actionAngleTorusStaeckel_call_and_orbit():
    ...
    orb = _tm_Orbit([float(numpy.atleast_1d(q)[0]) for q in o0])
