    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation w/ interpRZPotential fails at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation w/ interpRZPotential fails outside the grid at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation w/ interpRZPotential fails when the potential was not interpolated at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of Rforce w/ interpRZPotential fails at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
            assert (
                ...
                "RZPot interpolation of zforce w/ interpRZPotential fails at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    # This tests within the grid
    ...
    for r in rs:
        for z in zs:
            ...
            assert rforcediff < 10.0**-5.0, (
                "RZPot interpolation of Rforce w/ interpRZPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r, z, rforcediff
                )
            )
            ...
            assert zforcediff < 5.0 * 10.0**-5.0, (
                "RZPot interpolation of zforce w/ interpRZPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r, z, zforcediff
                )
            )
    # Test all at the same time to use vector evaluation
...
def test_interpolation_potential_force_use_c():
    ...
    assert numpy.all(
        numpy.fabs(rzpot._rforceGrid - rzpot_c._rforceGrid) < 10.0**-14.0
    ), (
        "Potential interpolation grid of Rforce  calculated with use_c does not agree with that calculated in python"
    )
    assert numpy.all(
        numpy.fabs(rzpot._zforceGrid - rzpot_c._zforceGrid) < 10.0**-14.0
    ), (
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of Rforce w/ interpRZPotential fails outside the grid at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
            assert (
                ...
                "RZPot interpolation of zforce w/ interpRZPotential fails outside the grid at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of Rforce w/ interpRZPotential fails when the potential was not interpolated at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
            assert (
                ...
                "RZPot interpolation of zforce w/ interpRZPotential fails when the potential was not interpolated at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
    ...
    for r in rs:
        for z in zs:
            ...
            assert densdiff < 10.0**-10.0, (
                "RZPot interpolation of density of density w/ interpRZPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r, z, densdiff
                )
            )
    # This tests within the grid
    ...
    for r in rs:
        for z in zs:
            ...
            assert densdiff < 4.0 * 10.0**-6.0, (
                "RZPot interpolation of density w/ interpRZPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r, z, densdiff
                )
            )
    # Test all at the same time to use vector evaluation
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of the density w/ interpRZPotential fails outside the grid at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of the density w/ interpRZPotential fails when the potential was not interpolated at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    return None
...
def test_interpolation_potential_vcirc():
    ...
    for r in rs:
        ...
        assert vcdiff < 10.0**-6.0, (
            "RZPot interpolation of vcirc w/ interpRZPotential fails at R = {:g} by {:g}".format(
                r, vcdiff
            )
        )
    # Test all at the same time to use vector evaluation
...
def test_interpolation_potential_vcirc_outsidegrid():
    ...
    for r in rs:
        ...
        assert vcdiff < 10.0**-10.0, (
            "RZPot interpolation w/ interpRZPotential fails outside the grid at R = {:g} by {:g}".format(
                r, vcdiff
            )
        )
    return None
...
def test_interpolation_potential_vcirc_notinterpolated():
    ...
    for r in rs:
        ...
        assert vcdiff < 10.0**-10.0, (
            "RZPot interpolation w/ interpRZPotential fails when the potential was not interpolated at R = {:g} by {:g}".format(
                r, vcdiff
            )
        )
    return None
...
def test_interpolation_potential_dvcircdR():
    ...
    for r in rs:
        ...
        assert dvcdrdiff < 10.0**-5.0, (
            "RZPot interpolation of dvcircdR w/ interpRZPotential fails at R = {:g} by {:g}".format(
                r, dvcdrdiff
            )
        )
    # Test all at the same time to use vector evaluation
...
def test_interpolation_potential_epifreq():
    ...
    for r in rs:
        ...
        assert epidiff < 10.0**-5.0, (
            "RZPot interpolation of epifreq w/ interpRZPotential fails at R = {:g} by {:g}".format(
                r, epidiff
            )
        )
    # Test all at the same time to use vector evaluation
...
def test_interpolation_potential_verticalfreq():
    ...
    for r in rs:
        ...
        assert vfdiff < 10.0**-5.0, (
            "RZPot interpolation of verticalfreq w/ interpRZPotential fails at R = {:g} by {:g}".format(
                r, vfdiff
            )
        )
    # Test all at the same time to use vector evaluation
