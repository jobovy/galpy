...
def test_initialization_SkyCoord():
    ...
    for ii in range(nrand):
        to= Orbit(co[ii])
        assert numpy.fabs((orbits.R()[ii]-to.R())/to.R()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vR()[ii]-to.vR())/to.vR()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vT()[ii]-to.vT())/to.vT()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.z()[ii]-to.z())/to.z()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vz()[ii]-to.vz())/to.vz()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs(((orbits.phi()[ii]-to.phi()+numpy.pi) % (2.*numpy.pi))-numpy.pi) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
...
def test_initialization_list_of_arrays():
    ...
    numpy.random.seed(1)
    nrand= 30
    ras= numpy.random.uniform(size=nrand)*360.
    decs= 90.*(2.*numpy.random.uniform(size=nrand)-1.)
    dists= numpy.random.uniform(size=nrand)*10.
    pmras= 20.*(2.*numpy.random.uniform(size=nrand)-1.)*20.
    pmdecs= 20.*(2.*numpy.random.uniform(size=nrand)-1.)*20.
    vloss= 200.*(2.*numpy.random.uniform(size=nrand)-1.)
    orbits= Orbit([ras,decs,dists,pmras,pmdecs,vloss],radec=True)
    for ii in range(nrand):
        to= Orbit([ras[ii],decs[ii],dists[ii],pmras[ii],pmdecs[ii],vloss[ii]],
                  radec=True)
        assert numpy.fabs((orbits.R()[ii]-to.R())/to.R()) < 1e-9, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vR()[ii]-to.vR())/to.vR()) < 1e-9, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vT()[ii]-to.vT())/to.vT()) < 1e-7, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.z()[ii]-to.z())/to.z()) < 1e-9, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs((orbits.vz()[ii]-to.vz())/to.vz()) < 1e-9, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
        assert numpy.fabs(((orbits.phi()[ii]-to.phi()+numpy.pi) % (2.*numpy.pi))-numpy.pi) < 1e-10, 'Orbits initialization with vxvv in 3D, 6 phase-D does not work as expected'
...
def test_slice_multipleobjects_multidim():
    ...
    for ii in range(3):
        for jj in range(1):
            for kk in range(2):
                assert numpy.amax(numpy.fabs(orbits_slice.x()[ii,kk]-orbits.x()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vx()[ii,kk]-orbits.vx()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.y()[ii,kk]-orbits.y()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vy()[ii,kk]-orbits.vy()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.z()[ii,kk]-orbits.z()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vz()[ii,kk]-orbits.vz()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.R()[ii,kk]-orbits.R()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vR()[ii,kk]-orbits.vR()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vT()[ii,kk]-orbits.vT()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.phi()[ii,kk]-orbits.phi()[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
    # After integration
    orbits.integrate(times,potential.MWPotential2014)
    orbits_slice= orbits[1:4,0,:2]
    for ii in range(3):
        for jj in range(1):
            for kk in range(2):
                assert numpy.amax(numpy.fabs(orbits_slice.x(times)[ii,kk]-orbits.x(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vx(times)[ii,kk]-orbits.vx(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.y(times)[ii,kk]-orbits.y(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vy(times)[ii,kk]-orbits.vy(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.z(times)[ii,kk]-orbits.z(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vz(times)[ii,kk]-orbits.vz(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.R(times)[ii,kk]-orbits.R(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vR(times)[ii,kk]-orbits.vR(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.vT(times)[ii,kk]-orbits.vT(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
                assert numpy.amax(numpy.fabs(orbits_slice.phi(times)[ii,kk]-orbits.phi(times)[ii+1,jj,kk])) < 1e-10, 'Integration of multiple orbits as Orbits does not agree with integrating multiple orbits'
    return None
...
def test_newOrbits():
    ...
    assert numpy.all(numpy.fabs(nos.R()-o.R(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct R"
    assert numpy.all(numpy.fabs(nos.vR()-o.vR(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct vR"
    assert numpy.all(numpy.fabs(nos.vT()-o.vT(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct vT"
    assert numpy.all(numpy.fabs(nos.z()-o.z(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct z"
    assert numpy.all(numpy.fabs(nos.vz()-o.vz(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct vz"
    assert numpy.all(numpy.fabs(nos.phi()-o.phi(ts[-2:])) < 10.**-10.), "New Orbits formed from calling an old orbit does not have the correct phi"
    assert not nos._roSet, "New Orbits formed from calling an old orbit does not have the correct roSet"
    assert not nos._voSet, "New Orbits formed from calling an old orbit does not have the correct roSet"
    return None
...
def test_badinterpolation():
    ...
    nos= o(ts[-2:]) #new Orbits
    #First t
    assert numpy.all(numpy.fabs(nos.R()-o.R(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct R"
    assert numpy.all(numpy.fabs(nos.vR()-o.vR(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct vR"
    assert numpy.all(numpy.fabs(nos.vT()-o.vT(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct vT"
    assert numpy.all(numpy.fabs(nos.z()-o.z(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct z"
    assert numpy.all(numpy.fabs(nos.vz()-o.vz(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct vz"
    assert numpy.all(numpy.fabs(nos.phi()-o.phi(ts[-2:])) < 10.**-10.), "New orbit formed from calling an old orbit does not have the correct phi"
    assert not nos._roSet, "New orbit formed from calling an old orbit does not have the correct roSet"
    assert not nos._voSet, "New orbit formed from calling an old orbit does not have the correct roSet"
