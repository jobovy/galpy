    ...
    for r in rs:
        for z in zs:
            assert numpy.fabs((sp(r, z) - kp(r, z)) / kp(r, z)) < 10.0**-10.0, (
                "RZPot interpolation w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
    ...
    for r in rs:
        for z in zs:
            assert numpy.fabs((sp(r, z) - kp(r, z)) / kp(r, z)) < 10.0**-5.0, (
                "RZPot interpolation w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
...
def test_interpsnapshotKeplerPotential_logR_eval():
    ...
    mz = mz.flatten()
    assert numpy.all(numpy.fabs((sp(mr, mz) - kp(mr, mz)) / kp(mr, mz)) < 10.0**-5.0), (
        "RZPot interpolation w/ interpRZPotential fails for vector input, w/ logR at (R,z) = ({:f},{:f}) by {:g}".format(
            mr[numpy.argmax(numpy.fabs((sp(mr, mz) - kp(mr, mz)) / kp(mr, mz)))],
            mz[numpy.argmax(numpy.fabs((sp(mr, mz) - kp(mr, mz)) / kp(mr, mz)))],
    ...
    for r in rs:
        for z in zs:
            assert numpy.fabs((sp(r, z) - spaz(r, z)) / sp(r, z)) < 10.0**-10.0, (
                "RZPot interpolation w/ InterpSnapShotPotential of KeplerPotential with different nazimuths fails at (R,z) = ({:g},{:g})".format(
                    r, z
                )
            )
...
def test_interpsnapshotKeplerPotential_epifreq():
    ...
    for r in rs:
        assert (
            ...
            "RZPot interpolation of epifreq w/ InterpSnapShotPotential of KeplerPotential fails at R = {:g} by {:g}".format(
                r, numpy.fabs((sp.epifreq(r) - kp.epifreq(r)) / kp.epifreq(r))
            )
        )
    # This tests within the grid
...
def test_interpsnapshotKeplerPotential_verticalfreq():
    ...
    for r in rs:
        assert (
            ...
            "RZPot interpolation of verticalfreq w/ InterpSnapShotPotential of KeplerPotential fails at R = {:g} by {:g}".format(
                r,
                numpy.fabs(
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of R2deriv w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r,
                    z,
                    numpy.fabs(
                        (sp.R2deriv(r, z) - kp.R2deriv(r, z)) / kp.R2deriv(r, z)
                    ),
                )
            )
    # This tests within the grid
    ...
    for r in rs:
        for z in zs:
            assert (
                ...
                "RZPot interpolation of z2deriv w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r,
                    z,
                    numpy.fabs(
    ...
    for r in rs:
        for z in zs:
            assert numpy.fabs(
                ...
                "RZPot interpolation of Rzderiv w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g}) by {:g}; value is {:g}".format(
                    r,
                    z,
                    numpy.fabs(
                        (sp.Rzderiv(r, z) - kp.Rzderiv(r, z)) / kp.Rzderiv(r, z)
    ...
    for r in rs:
        for z in zs:
            assert numpy.fabs(
                ...
                "RZPot interpolation of Rzderiv w/ InterpSnapShotPotential of KeplerPotential fails at (R,z) = ({:g},{:g}) by {:g}".format(
                    r,
                    z,
                    numpy.fabs(
                        (sp.Rzderiv(r, z) - kp.Rzderiv(r, z)) / kp.Rzderiv(r, z)
